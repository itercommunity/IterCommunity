...
Tags: zotero, icpress, citation manager, citations, citation, cite, citing, bibliography, bibliographies, reference, referencing, references, reference list, reference manager, academic, academia, scholar, scholarly, cv, curriculum vitae, resume, publish, publications
...
= Requirements =
jQuery included in your theme (ICPress will do this for you if it isn't already included), and an HTTP request method supported by WordPress enabled on your server: cURL, fopen with Streams (PHP 5), or fsockopen. Optional: OAuth enabled on your server.

== Installation ==

1. Upload the folder `icpress` to the `/wp-content/plugins/` directory.
1. Activate the plugin through the 'Plugins' menu in WordPress.
1. Place the `[icpress]` shortcode in your blog entry or enable the ICPress sidebar widget.
...
[icpressInText item="{U9Z5JTKC,36-45}"]

This shortcode will display the following in-text citation for the citation with the key "U9Z5JTKC": (Seaborn, 2011, p. 36). The full citation can be displayed in an auto-generated bibliography using the [icpressInTextBib] shortcode.

Check out the "Help" page on your installation of ICPress for more information and a full listing of parameters for all shortcodes.

== Frequently Asked Questions ==

The F.A.Q. can be found on the "Help" page of every ICPress installation. If you have a question that isn't answered there, feel free to post a message in the [forums](http://wordpress.org/tags/icpress "Zotero forums on Wordpress.com").
...
2. Search for items and build bibliography and in-text shortcodes using the "ICPress Reference" meta box widget.
...
* New! "icpressLib" shortcode for displaying your library on the front-end of your website.
...
* Fixed icp_get_year warning messages.
...
* Confirmed that ICPress works with WP 4.0.
...
* IMPORTANT! You must re-import your Zotero library/libraries in ICPress when you install this version or your shortcodes will not display correctly.
...
* ICPress now requires version 3.5 of WordPress.
...
* New! Enable or disable ICPress Reference Widget for specific post types.
...
* New! Reset ICPress feature on Options page.
...
* Added default account constraint to ICPress Reference results.

= 5.0.4 =

* Fixed table install, update and uninstall issues.
* New import and sync scripts for large libraries.
* ICPress admin now accessible to Editors.
...
* Happy new year! ICPress is now optimized for Wordpress 3.5.
...
* Expanded ICPress In-Text capabilities, including multiple items and formatting.
...
* Many more additions and bug fixes. Explore and enjoy the new ICPress!
...
* New! Set default citation style (for all posts, via ICPress Reference Metabox Widget).

= 4.5 =
* New: Shortcode Creator in the ICPress Reference Metabox Widget.
...
* The ICPress shortcode now accepts lists for these parameters: collection, item.
* Notes can now be shown, if made publicly available through Zotero.
* ICPress Reference should now show up on custom post type writing/editing pages.
* ICPress Reference now working with the latest versions of Chrome and Safari.

= 4.3 =
* Introducing "ICPress InText", a new shortcode that let's you add in-text citations, and then auto-generates a bibliography for you. jQuery must be enabled. Only supports APA style; requests can be made in the forums. Use information can be found in your ICPress installation's "Help" page.
...
* Added more information to and sorting of citations listed in the ICPress Reference widget.
...
= 3.0 =
* New "ICPress Reference" widget, meant to speed up the process of adding shortcodes to your posts and pages by allowing you to selectively search for ids directly on the add and edit pages.
...
* I've changed the way ICPress's admin splash page loads. Before, the page would hang until finished loading the latest citations from Zotero. This is a friendlier way of letting you know what ICPress is up to.
...
* Improved handling of multiple ICPress shortcode calls on a single page.
...
* "Forcing cURL" option abandoned. If your server supports it, cURL will be used; otherwise, ICPress will resort to file_get_contents(). 
...
= 2.0 =
* ICPress completely restructured.
...
= 1.2 =
* Optimized JavaScript functions. Fixed some grammatical errors on the Help page. More selective loading of JavaScript. And most importantly ... added a ICPress widget option. This also means you can have more than one ICPress call on a single page.
...
= 1.0 =
* ICPress makes its debut.

== Upgrade Notice ==

= 1.2 =
Lots of little issues fixed. Plus, you can now use a ICPress widget instead of shortcode.
...
= 2.0 =
ICPress overhaul. Security and performance increases.
...
= 3.0 =
Major release! OAuth, convenient "ICPress Reference" meta box, friendly lag handling, numerous bug fixes, and more!
...
= 4.3 =
ICPress InText and various fixes.

= 4.4 =
Security measures added. Fixed "Help" page info. ICPress shortcode now accepts lists for these parameters: collection, item. Notes can now be shown. ICPress Reference on custom post type writing/editing pages and working with the latest versions of Chrome and Safari.
