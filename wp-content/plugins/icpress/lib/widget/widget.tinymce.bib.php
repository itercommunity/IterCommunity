...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		<title>ICPress Bibliography</title>
		...
		.icp-ICPress-TinyMCE-Popup h4 { color: #666666; padding: 0.5em 1em; margin: 0.25em 0; }
		.icp-ICPress-TinyMCE-Popup div#icp-ICPressMetaBox-Biblio-Options { margin: 0; }
		.icp-ICPress-TinyMCE-Popup #icp-ICPressMetaBox-Biblio-Options-Inner { display: none; }
        ...
        jQuery(document).ready(function() {
					...
					for (var i = 0; i < attributes.length; i++)
					{
						...
						if ( attribute[0].replace(/"/gi, '') == "item")
						{
							...
							if (scItems.length > 1) // multiple items
							{
								...
								{
									jQuery("#icp-ICPressMetaBox-Biblio-Citations-List-Inner").append("<div class='item' rel='"+scItems[s]+"'><span class='label'>"+summary[s]+"</span><div class='toggle'></div><div class='delete'></div><div class='options'><div class='id'>Key: "+scItems[s]+"</div></div></div>\n");
								}
							}
							else if (scItems.length == 1) // one item
							{
								jQuery("#icp-ICPressMetaBox-Biblio-Citations-List-Inner").append("<div class='item' rel='"+scItems[0]+"'><span class='label'>"+summary[0]+"</span><div class='toggle'></div><div class='delete'></div><div class='options'><div class='id'>Key: "+scItems[0]+"</div></div></div>\n");
							}
						}
            ...
            jQuery("#icp-TinyMCESave").click(function()
			{
				...
				// Check items
				if ( jQuery("#icp-ICPressMetaBox-Biblio-Citations-List .item").length > 0 )
				{
					zpItemsExist = true;
					summary = "";
					var newShortcode = "[icpress userid=\""+jQuery("#icp-ICPressMetaBox-Account-ID").text()+"\"";
					var newShortcodeItems = "";
					
					jQuery("#icp-ICPressMetaBox-Biblio-Citations-List .item").each(function()
					{
				...
				{
					tinyMCEPopup.editor.execCommand('mceInsertContent', false, "<span class=\"icp-ICPressShortcode bib\"><span class='summary'>"+summary+"</span><span class='shortcode'>"+newShortcode+"</span></span>");
				}
	...
	<body id="icp-ICPress-TinyMCE-Cite" class="icp-ICPress-TinyMCE-Popup wp-core-ui">
		...
		<div id="icp-ICPressMetaBox-Bibliography">
			...
			<!-- START OF ACCOUNT -->
			<div id="icp-ICPressMetaBox-Biblio-Account">
				<?php
			...
			<div id="icp-ICPressMetaBox-Biblio-Options">
				...
				<div id="icp-ICPressMetaBox-Biblio-Options-Inner">
					...
					<input type="text" id="icp-ICPressMetaBox-Biblio-Options-Author" name="author" value="" />
					
					<hr />
					
					<label for="icp-ICPressMetaBox-Biblio-Options-Year">Filter by Year:</label>
					<input type="text" id="icp-ICPressMetaBox-Biblio-Options-Year" name="year" value="" />
					...
					<label for="icp-ICPressMetaBox-Biblio-Options-Style">Style:</label>
						...
						?>
					<input id="icp-ICPressMetaBox-Biblio-Options-Style" name="style" type="text" value="<?php echo $icp_default_style; ?>" />
					...
					<select id="icp-ICPressMetaBox-Biblio-Options-SortBy" name="sortby">
					...
					<input type="text" id="icp-ICPressMetaBox-Biblio-Options-Limit" name="limit" value="" />
