...
if (!class_exists('ICPressRequest'))
{
        class ICPressRequest
        {
                ...
                function doRequest( $xml_url )
                {
                        ...
                        //if ($this->checkTime($icp_cache[0]->cache_time) === true || $this->update === true) // Every hour (3600), or when forced
                        //{
                        //        // UPDATE
                        //}
                        //
